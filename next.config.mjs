...
const securityHeaders = [
  ...
  // Mise à jour de la directive Content-Security-Policy
  {
    ...
    value:
      "default-src 'self'; worker-src 'self'; manifest-src 'self'; frame-src 'self'; script-src 'self' https://cdnjs.cloudflare.com; style-src 'self' https://cdnjs.cloudflare.com; media-src 'self' https://res.cloudinary.com ; img-src 'self' data: blob: https://res.cloudinary.com; font-src 'self' https://cdnjs.cloudflare.com; connect-src 'self' https://res.cloudinary.com https://sentry.io https://*.ingest.sentry.io https://*.sentry.io;",
  },
];
